...
Just like any bot, Tropica has and experiences errors. This page is to help you with some errors you may encounter when using our bot!

## Configuration Based Errors
Most, if not all, errors you may encouter with Tropica will result in not configuring the bot.
